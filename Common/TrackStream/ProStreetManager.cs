...
{
    public class ProStreetManager : GameBundleManager
    {
        [StructLayout(LayoutKind.Sequential, Pack = 1, Size = 92)]
        private struct ProStreetSection
        {
        ...
        public override void ReadFrom(string gameDirectory)
        {
            ...
            foreach (var bundleFile in Directory.EnumerateFiles(tracksDirectory, "L6R_*.BUN"))
            {
        ...
        public override LocationBundle ReadLocationBundle(string bundlePath)
        {
            ...
            using (var br = new BinaryReader(fs))
            {
                ...
                var sectionStructSize = Marshal.SizeOf<ProStreetSection>();
                ...
                {
                    var section = BinaryUtil.ReadStruct<ProStreetSection>(br);
