...
namespace Common.Geometry
{
    ...
    public class UndercoverSolids : SolidListManager
    {
        ...
        private static Dictionary<uint, UndercoverObject.EffectID> _effectIdMapping =
            new Dictionary<uint, UndercoverObject.EffectID>
            {
        ...
        private UndercoverObject ReadObject(BinaryReader br, long size, UndercoverObject solidObject = null)
        {
            if (solidObject == null)
