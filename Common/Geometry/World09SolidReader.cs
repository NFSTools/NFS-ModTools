...
public class World09SolidReader : SolidReader<World09Object, World09Material>
{
    private int _namedMaterials;

    public World09SolidReader()
    {
        Solid = new World09Object();
    }
    ...
    private void ReadSolidPlatMeshEntries(BinaryReader binaryReader, uint chunkSize)
    {
        ...
        for (var j = 0; j < numMats; j++)
        {
            ...
            var solidObjectMaterial = new World09Material
            {
    ...
    protected override SolidMeshVertex GetVertex(BinaryReader reader, World09Material material, int stride)
    {
