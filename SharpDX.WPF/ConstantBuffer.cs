        ...
        where T : struct
    {
        ...
        public T Value
        {
            ...
            set
            {
                ...
                var db = new DataBox(_dataStream.DataPointer, 0, 0);
                _device.ImmediateContext.UpdateSubresource(db, _buffer, 0);
        ...
        where T : struct
    {
        ...
        public T Value
        {
            ...
            set
            {
                ...
                var db = new DataBox(_dataStream.DataPointer, 0, 0);
                _device.UpdateSubresource(db, _buffer, 0);
